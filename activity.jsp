...
<html>
	...
	<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-0" data-genuitec-path="/society/WebRoot/activity.jsp">
		
	<div class="fh5co-loader" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-0" data-genuitec-path="/society/WebRoot/activity.jsp"></div>
	...
	<aside id="fh5co-hero">
		<div class="flexslider">
			<ul class="slides">
		   	<li style="background-image: url(images/社团活动.jpg);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1 class="heading-section">社团活动</h1>
									<h2>无所不在</h2>
			   				</div>
			   			</div>
			   		</div>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
					<h2>社团活动了解</h2>
					<p>此版块是为了给广大学生了解我校各社团的窗口，通过对各个社团具体的活动进行了解</p>
				</div>
			</div>
			<div class="row">
				<c:if test="${empty ac}">
				...
				<c:forEach items="${ac}" var="c">
					...
					<div class="course">
						<div class="desc" style="width: 100%;">
							<h3><a href="#">${c.theme }</a></h3>
							<span class="posted_on">时间：${c.date }<</span>
							<br>
							<p>社团：<span>${c.community}</span></p>
							<p>场地：<span>${c.location}</span></p>
							<p>对象：<span>${c.object}</span></p>
							<span><a href="FindactivityBytheme?id=${c.id} " class="btn btn-primary btn-sm btn-course">了解更多</a></span>
						</div>
					</div>
					</div>
				</c:forEach>
