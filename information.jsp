...
<html>
	...
	<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-42" data-genuitec-path="/society/WebRoot/information.jsp">
		
	<div class="fh5co-loader" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-42" data-genuitec-path="/society/WebRoot/information.jsp"></div>
				...
				<div class="row">
					...
					<div class="col-xs-10 text-right menu-1">
						<ul>
							...
							<li class="active"><a href="information">信息</a></li>
	...
	<aside id="fh5co-hero">
		<div class="flexslider">
			<ul class="slides">
		   	<li style="background-image: url(images/信息背景.jpg);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1 class="heading-section">社团汇总</h1>
									<h2>了解各类社团，加入社团吧！</h2>
			   				</div>
			   			</div>
			   		</div>
		...
		<div class="container">
			<div class="row">
				...
				<c:forEach items="${in}" var="i">
					...
					<div class="staff">
						<div class="staff-img" style="background-image: url(${i.logopath });">
						</div>
						<h3>${i.comunityname }</h3>
						<p>${i.resume }</p>
						<span><a href="join?comunityname=${i.comunityname}&name=${user.name}" class="btn btn-primary btn-sm btn-course">加入我们</a></span>
					</div>
				</div>
				</c:forEach>
				</c:if>
