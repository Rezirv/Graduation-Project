...
<html>
	...
	<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-45" data-genuitec-path="/society/WebRoot/notice.jsp">
		
	<div class="fh5co-loader" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-45" data-genuitec-path="/society/WebRoot/notice.jsp"></div>
				...
				<div class="row">
					...
					<div class="col-xs-10 text-right menu-1">
						<ul>
							...
							<li class="active"><a href="notice">通知</a></li>
	...
	<aside id="fh5co-hero">
		<div class="flexslider">
			<ul class="slides">
		   	<li style="background-image: url(images/通知背景.jpg);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1 class="heading-section">通知</h1>
									<h2>关于社团大事件的通知</h2>
			   				</div>
			   			</div>
			   		</div>
		...
		<div class="container">
			...
			<c:if test="${not empty cs}">
				<c:forEach items="${cs}" var="c">
					...
					<h3>${c.comunity }</h3>
					<h3>地点：${c.location }</h3>
					<span class="posted_on">${c.time }</span>
					<p>${c.more }</p>
					<hr>
			</div>
				</c:forEach>
