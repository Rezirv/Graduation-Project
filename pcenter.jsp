...
<html>
	...
	<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-46" data-genuitec-path="/society/WebRoot/pcenter.jsp">
		
	<div class="fh5co-loader" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-46" data-genuitec-path="/society/WebRoot/pcenter.jsp"></div>
				...
				<div class="row">
					...
					<div class="col-xs-10 text-right menu-1">
						<ul>
							...
							<li class="active"><a href="pcenter?name=${user.name}">个人中心</a></li>
	...
	<aside id="fh5co-hero">
		<div class="flexslider">
			<ul class="slides">
		   	<li style="background-image: url(images/个人中心背景.jpg);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="row">
			   			<div class="col-md-8 col-md-offset-2 text-center slider-text">
			   				<div class="slider-text-inner">
			   					<h1 class="heading-section">个人中心</h1>
									<h2>个人社团信息</h2>
			   				</div>
			   			</div>
			   		</div>
	...
	<div id="fh5co-contact">
		<div class="container">
			<div class="row">
				<div class="col-md-9 col-md-push-1 animate-box text-center">
					<div class="fh5co-contact-info" style="margin-left: 300px; margin-bottom: 0px;">
						<h3>个人信息</h3>
						<ul>
							<li class="address">${pc.name}</li>
							<li class="phone">${pc.tel}</a></li>
							<li class="email">${pc.email}</a></li>
				...
				<c:if test="${not empty ap}">
					...
					<div class="fh5co-blog animate-box">
						<a href="#" class="blog-img-holder" style="background-image: url(images/project-1.jpg);"></a>
						<div class="blog-text">
							<h3><a href="#">${p.comunityname}</a></h3>
							<p>职务：<span>${p.position}</span></p>
						</div> 
					 </div>
				   </div>
				  </c:forEach>
